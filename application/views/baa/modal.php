...
<div class="modal fade modal-primary-custom" id="baaTambahRegistrasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal fade modal-primary-custom" id="baaTambahPembayaran" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
